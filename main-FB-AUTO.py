                ...
                for miss_ent_domain in range(1, ary + 1):
                    ...
                    for j in range(0, len(er_vocab_pairs), self.batch_size):
                        data_batch, label, rel_idx, ent_idx = self.get_batch(er_vocab, er_vocab_pairs, j,
                                                                             miss_ent_domain)
                        pred, _ = model.forward(rel_idx, ent_idx, miss_ent_domain)
                        pred = pred.to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="FB-AUTO", nargs="?",
    ...
    parser.add_argument("--lr", type=float, default=0.00002, nargs="?", help="Learning rate.")
