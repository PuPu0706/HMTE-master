...
class Experiment:
    ...
    def train_and_eval(self):
        ...
        model = HMTE(len(d.ent2id), len(d.rel2id), self.dembd, self.max_ary, self.device, self.layer_num,
                     d.ent_relnel, ary_list=self.ary_list)
        model.to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="WikiPeople", nargs="?",
    ...
    parser.add_argument("--layer_num", type=int, default=8, nargs="?", help="layer_num.")
    ...
    Exp = Experiment(num_iterations=param['num_iterations'],
